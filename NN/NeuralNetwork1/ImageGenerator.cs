...
namespace NeuralNetwork1
{
    ...
    /// Тип фигуры
    /// </summary>
    public enum AutoType : byte { Citroen = 0, Ford, Hyundai, Infiniti, Mercedes, MM, Opel, Renault, Toyota, VW, Undef };
    ...
    public class GenerateImage
    {
        ...
        /// </summary>
        public AutoType currentAuto = AutoType.Undef;
        ...
        */
        ...
        {
            currentAuto = AutoType.Rectangle;
        ...
        public void generate_figure(AutoType type = AutoType.Undef)
        {

            if (type == AutoType.Undef || (int)type >= FigureCount)
                type = (AutoType)rand.Next(FigureCount);
            ClearImage();
            switch (type)
            {
                case AutoType.Rectangle : create_rectangle(); break;
                case AutoType.Triangle  : create_triangle(); break;
                case AutoType.Circle    : create_circle(); break;
                case AutoType.Sinusiod  : create_sin(); break;
